...
import (
	...
	fasthttpapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/fasthttp/testcase"
	fiberapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/fiber/testcase"
	ginapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/gin/testcase"
	gozeroapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/go-zero/testcase"
	goframeapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/goframe/testcase"
	gorillamuxapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/gorilla-mux/testcase"
	hertzapi "github.com/uptrace/oapi-codegen-dd/v3/examples/server/test/hertz/testcase"
